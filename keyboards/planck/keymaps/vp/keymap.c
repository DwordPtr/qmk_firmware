...
[_QWERTY] = LAYOUT_planck_grid(
    LT(FL3, KC_ESC),  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    LT(FL1,KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT,KC_ENT),
    KC_LCTL, MO(FL3), KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, MO(FL2), KC_UP,   KC_RCTL 
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LALT, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[FL2] = LAYOUT_planck_grid(
    KC_ESC,  TMUX_1,    TMUX_2,    TMUX_3,    TMUX_4,    KC_T,    KC_COPY,    KC_U,    KC_MPRV, KC_MPLY, KC_MNXT,    KC_BSPC,
    KC_TAB,  WHPTXT,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,    KC_H,    KC_J,    KC_VOLD, KC_MUTE, KC_VOLU, KC_QUOT,
    KC_LSFT, KC_Z,    TMUX_DEST,    TMUX_CREAT,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT,KC_ENT),
    KC_LCTL, KC_LALT, KC_LALT, KC_BTN1, KC_BTN2,   KC_SPC,  KC_SPC,  RAISE,   KC_HOME, KC_DOWN, KC_UP,   KC_END
),
...
[FL3] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LALT, KC_TRNS, KC_TRNS, KC_BTN2,   KC_0,  KC_0,  RAISE,   KC_RALT, KC_DOWN, KC_UP,   KC_RCTL
),
